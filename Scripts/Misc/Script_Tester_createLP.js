...
if ((wfTask == 'Permit Issuance' && wfStatus == 'Issued') && getLicenseProf(null,['TBD'])) 
{
        showMessage = true;
...
// Add TBD Contractor to Record.
if (AInfo["Is a contractor to be determined?"] == "Yes") {
	//var rlpType = "Contractor",	rlpId = "8212", lpBoard = null, lpExpirDate = null, lpFirstName = "", lpLastName = "To Be Determined";
//	var rlpType = "Contractor",	rlpId = "TBD", lpBoard = null, lpExpirDate = null, lpFirstName = "", lpLastName = "To Be Determined";
//	createLP(rlpId, rlpType, capId, lpBoard, lpExpirDate, lpFirstName, null, lpLastName);
	createLP("Contractor","TBD",capId,null,null,"",null,"To Be Determined");
}
